...
Load [worktree-reference.md](worktree-reference.md) for the exact command recipes. For each repo in scope:
...
Use the age-filtered container, image, and builder recipes in [worktree-reference.md](worktree-reference.md).
...
For remote cleanup, use the SSH recipe in [worktree-reference.md](worktree-reference.md) and apply the same ownership, status, merge, and uniqueness gates.
