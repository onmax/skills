---
name: people-skills
description: Drafts human-centered messages and recommends interpersonal next actions using practical relationship principles. Use when the user asks for emails, DMs, apologies, conflict repair, influence, persuasion, feedback, favors, boundaries, or advice for a personal or professional situation with another person.
---
...
Help the user communicate in a sincere, specific, relationship-preserving way. Use the nine principles below as diagnostic lenses, not as a script to manipulate people.
