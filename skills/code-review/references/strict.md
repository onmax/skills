...
- Use `ponytail:ponytail` when the strict review needs the smallest useful scope, a narrower API surface, or a shorter correct implementation.
...
- `ponytail:ponytail` | `validate-direction` | `handoff` | none
```
