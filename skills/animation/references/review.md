...
Be specific and cite `file:line`. When a value is needed, pull the exact curve, duration, or spring config from [standards.md](standards.md) rather than approximating.
