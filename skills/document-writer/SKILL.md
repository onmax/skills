...
1. Load the relevant reference file: [writing-style.md](references/writing-style.md) for prose, [content-patterns.md](references/content-patterns.md) for structure.
2. Draft content using active voice and present tense.
3. Apply the checklist below to verify quality, and revise anything that fails.
