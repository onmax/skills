...
When there is no representative prompt to refine, use [prompt-examples.md](prompt-examples.md) as a shape reference. Copy its information order, not its wording or headings.
